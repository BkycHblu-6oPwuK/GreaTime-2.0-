            ...
            <div class="assortment_block">
                <div class="card">
                    <div class="card_tovar">
                        <a href="catalog/19"><img class="img_tovar" src="{{asset('img/categories/тяж.png')}}" alt=""></a>
                    </div>
                    <div class="card_tovar">
                        <a href="catalog/23"><img class="img_tovar" src="{{asset('img/categories/одежда.png')}}" alt=""></a>
                    </div>
                </div>
                <div class="card">
                    <div class="card_tovar">
                        <a href="catalog/12"><img class="img_tovar" src="{{asset('img/categories/обувь.png')}}" alt=""></a>
                    </div>
                    <div class="card_tovar">
                        <a href="catalog/11"><img class="img_tovar" src="{{asset('img/categories/фитнес.png')}}" alt=""></a>
                    </div>
                </div>
                <div class="card">
                    <div class="card_tovar">
                        <a href="catalog/22"><img class="img_tovar" src="{{asset('img/categories/летние.png')}}" alt=""></a>
                    </div>
                    <div class="card_tovar">
                        <a href="catalog/13"><img class="img_tovar" src="{{asset('img/categories/турник.png')}}" alt=""></a>
                    </div>
                </div>
                <div class="card">
                    <div class="card_tovar">
                        <a href="catalog/15"><img class="img_tovar" src="{{asset('img/categories/лыж.png')}}" alt=""></a>
                    </div>
                    <div class="card_tovar">
                        <a href="catalog/18"><img class="img_tovar" src="{{asset('img/categories/бок.png')}}" alt=""></a>
                    </div>
                </div>
                <div class="card">
                    <div id="card_tovar_end" class="card_tovar">
                        <a href="catalog/16"><img class="img_tovar" src="{{asset('img/categories/конь.png')}}" alt=""></a>
                    </div>
                    <div id="card_tovar_end" class="card_tovar">
                        <a href="catalog/17"><img class="img_tovar" src="{{asset('img/categories/хоккей.png')}}" alt=""></a>
                    </div>
                </div>
            </div>
        </div>
